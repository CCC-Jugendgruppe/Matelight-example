...
#            raise ValueError("crates_vertical has to be odd, if crates_horizontal is larger than 1!")
    ...
    def set_pixel(self, x, y, r, g, b, position_overflow=''):
        """
        ...
        position_overflow valid values: modulo, border, anything else (default)
        """
        if position_overflow == 'modulo':
            x = x % self.width
            y = y % self.height
        elif position_overflow == 'border':
